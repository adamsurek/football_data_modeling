...
select
    ...
    {{ clean_string('posteam') }} as nfl_team_code_possessing,
    {{ clean_string('defteam') }} as nfl_team_code_defending,
    ...
    {{ clean_string('td_team') }} as nfl_team_code_touchdown,
    ...
    {{ clean_string('return_team') }} as nfl_team_code_return_team,
    ...
    {{ clean_string('timeout_team') }} as nfl_team_code_timeout,
    {{ clean_bool('penalty') }} as flag_penalty,
    {{ clean_string('penalty_player_id') }} as gsis_player_id_penalized,
    {{ clean_string('penalty_team') }} as nfl_team_id_penalized,
    {{ clean_string('penalty_type') }} as penalty_type,
    {{ clean_integer('penalty_yards') }} as penalty_yards,
    ...
    {{ clean_string('solo_tackle_1_team') }} as nfl_team_code_solo_tackler_1,
    {{ clean_string('solo_tackle_1_player_id') }} as gsis_player_id_solo_tackler_1,
    {{ clean_string('solo_tackle_2_team') }} as nfl_team_code_solo_tackler_2,
    {{ clean_string('solo_tackle_2_player_id') }} as gsis_player_id_solo_tackler_2,
    {{ clean_string('assist_tackle_1_team') }} as nfl_team_code_assist_tackler_1,
    {{ clean_string('assist_tackle_1_player_id') }} as gsis_player_id_assist_tackler_1,
    {{ clean_string('assist_tackle_2_team') }} as nfl_team_code_assist_tackler_2,
    {{ clean_string('assist_tackle_2_player_id') }} as gsis_player_id_assist_tackler_2,
    {{ clean_string('assist_tackle_3_team') }} as nfl_team_code_assist_tackler_3,
    {{ clean_string('assist_tackle_3_player_id') }} as gsis_player_id_assist_tackler_3,
    {{ clean_string('assist_tackle_4_team') }} as nfl_team_code_assist_tackler_4,
    ...
    {{ clean_string('tackle_with_assist_1_team') }} as nfl_team_code_tackle_with_assist_tackler_1,
    {{ clean_string('tackle_with_assist_1_player_id') }} as gsis_player_id_tackle_with_assist_tackler_1,
    {{ clean_string('tackle_with_assist_2_team') }} as nfl_team_code_tackle_with_assist_tackler_2,
    ...
    {{ clean_string('fumbled_1_team') }} as nfl_team_code_fumbler_1,
    {{ clean_string('fumbled_2_player_id') }} as gsis_player_id_fumbler_2,
    {{ clean_string('fumbled_2_team') }} as nfl_team_code_fumbler_2,
    {{ clean_string('fumble_recovery_1_player_id') }} as gsis_player_id_fumble_recoverer_1,
    {{ clean_string('fumble_recovery_1_team') }} as nfl_team_code_fumble_recoverer_1,
    ...
    {{ clean_string('fumble_recovery_2_team') }} as nfl_team_code_fumble_recoverer_2,
    {{ clean_string('fumble_recovery_2_yards') }} as fumble_recoverer_2_yards,
    {{ clean_string('forced_fumble_player_1_team') }} as nfl_team_code_fumble_forcer_1,
    {{ clean_string('forced_fumble_player_1_player_id') }} as gsis_player_id_fumble_forcer_1,
    {{ clean_string('forced_fumble_player_2_team') }} as nfl_team_code_fumble_forcer_2,
